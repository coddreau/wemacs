class @Acemacs 
  constructor: (container) ->
    window.editor = ace.edit $(container).get(0)
    window.editor.setShowPrintMargin(false)
    window.editor.setDisplayIndentGuides(false)
    ...
    window.editor.commands.addCommand(name: 'acemacs', bindKey: {win: 'Esc'}, exec: emacsCommand)
    window.editor.commands.addCommand(name: 'save', bindKey: {win: 'Ctrl-S'}, exec: saveCurrentDocument)
